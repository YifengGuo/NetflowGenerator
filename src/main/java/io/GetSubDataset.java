...
public class GetSubDataset {
    ...
    public static void main(String[] args) throws Exception {
        ...
        getHead100(sourceFile);
        getHead2Million(sourceFile);
    }

    private static void getHead100(String filePath) throws Exception {
        BufferedReader br = new BufferedReader(new FileReader(filePath));
        PrintWriter writer = new PrintWriter("src/main/dataset/head100.netflow");
        String line = null;
        int lineCount = 0;
